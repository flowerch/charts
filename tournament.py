...
def swissPairings():
    ...
    """
    # For itertools and pairingsiterator
    # consulted the Python Standard Library 9.7 and
    # the recipes section of Python's itertools docs at:
